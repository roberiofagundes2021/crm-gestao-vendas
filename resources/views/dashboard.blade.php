...
@section('content')
    <div class="row justify-content-start mt-0 mr-5 g-5">
        ...
        <div class="offset-2 row-sm-6 text-light">
                    ...
                    <div class="row mt-5">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                ...
                                <path
                                    d="M8.354 1.146a.5.5 0 0 0-.708 0l-6 6A.5.5 0 0 0 1.5
        ...
        <div class="col-16 mt-0 p-2 ml-0 me-2 position-sticky">
                    ...
                    <div class="card w-25 bg-secondary" >
                        <div class="card-header text-dark"style="width: 13rem;">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                ...
                                <path
                                    d="M10.97 4.97a.235.235 0 0 0-.02.022L7.477 9.417 5.384 7.323a.75.75
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                ...
                                <path
                                    d="M10.067.87a2.89 2.89 0 0 0-4.134 0l-.622.638-.89-.011a2.89
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                ...
                                <path
                                    d="M2.5.5A.5.5 0 0 1 3 0h10a.5.5 0 0 1 
                                ...
                                <div class="col">
                                    <i class="telephone">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            ...
                                            <path
                                                d="M3.5 6.5A.5.5 0 0 1 4 7v1a4 4 0 0 0 8 0V7a.5.5 0 0
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            ...
                                            <path
                                                d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 
            ...
            <div class="row">
                <div class="row bg-write pl-5">
                    <div class="card mb-2 bg-secondary me-2  mt-0 mr-2" style="width: 18rem; height: 20rem">
                    ...
                    <div class="offset-0.5 card mb-2 bg-secondary mt-1" style="width: 14rem; height:20rem">

                        <div class="card-header ">
                            <!-- inicio de card-->
                            <div class="card" style="width: 12rem;">
                                <ul class="list-group list-group-flush text-dark h-40">
                                    <li class="list-group-item text-dark">Balanço</li>
                                    <li class="list-group-item text-dark">R$ 27.540,00</li>
                                    <li class="list-group-item text-dark">R$ 32.898,00</li>
                                    <li class="list-group-item text-dark">90%</li>
                                </ul>
                            </div>
                            <!--fim de card-->
                        </div>
