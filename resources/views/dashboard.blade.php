...
@section('content')
        ...
        <div class="row justify-content-start mt-0 mr-5 g-5">
            ...
            <!------------------------------------------------------------------>
            <div class="col-16 mt-0 p-2 ml-2 me-2 position-sticky">
                <div class=" card mt-0 bg-light">
                        <!--cards -->
                            <div class=" row bg-secondary pl-5">
                                <div class="ml-0 card mb-2 bg-secondary mt-1" style="width: 18rem;">
                                ...
                                <div class="offset-0.5 card mb-2 bg-secondary mt-1 " style="width: 8rem;">
                                        <div class="card-header text-dark">
                                             <!--selo-->
                                            <span>R$ 300,00</span>
                            ...
                            <div class=" card mb-2 bg-secondary mt-0.5" style="width: 16rem;">
                                        <!--inicio do cards -->
                                             <div class="card-header  ">
                                            <h5 class="card-title text-dark">ECOMMERCE PERSONALIZADO R$ 30.000,00</h5>
                                            <p class="card-text text-dark">
                            ...
                            <div class="row bg-secondary pl-5">
                                ...
                                <div class="offset-0.5 card mb-2 bg-secondary mt-1" style="width: 14rem;">
                                        ...
                                        <div class="card-header ">
                                            <!-- inicio de card-->
                                                <div class="card h-40" style="width: 12rem;">
