<nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent m-1">
    <div class="container-fluid" style="background:#FFF; m-4">
     <img src="{{ asset('black') }}/imagem/logo.PNG" alt="140px" style="height:70px;">
        ...
        <button class="navbar-toggler" type="button" data-toggle="collapse"
         data-target="#navigation" aria-expanded="false" aria-label="{{ __('Toggle navigation') }}">
                    ...
                    <button class="btn btn-link" id="search-button" data-toggle="modal"
                     data-target="#searchModal">
                        ...
                        fill="currentColor" class="bi bi-bell" viewBox="0 0 16 16">
                            <path d="M8 16a2 2 0 0 0 2-2H6a2 2 0 0 0 
