...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('web4_negocios_categorias', function (Blueprint $table) {
            $table->comment('');
            ...
            $table->integer('CodigoResponsavel')->default(0);
            $table->integer('CodigoGrupoResponsavel')->default(0);
    ...
    {
        Schema::dropIfExists('web4_negocios_categorias');
    }
};
